...
Spoilt Milk is a custom-built MERN stack (MongoDB, Express, React, Node.js) application designed to catalog horror movies and store highly subjective, unhinged reviews by yours truely <3
...
## 🛠️ The Tech Stack (Weapons of Choice)
* **Frontend:** React (Vite), React-Router-DOM, React-Bootstrap, pure unadulterated CSS.
...
## 🩸 Summoning the App (Installation)

Want to run this haunted house on your local machine? Follow these cursed steps:
